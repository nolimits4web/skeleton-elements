...
- Create an [issue](https://github.com/nolimits4web/skeleton-elements/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/nolimits4web/skeleton-elements/issues), assuming one does not already exist.
