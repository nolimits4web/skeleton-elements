...
import { SvelteComponent, append, assign, attr, create_slot, detach, element, exclude_internal_props, get_slot_changes, get_slot_context, get_spread_update, init, insert, safe_not_equal, set_attributes, space, svg_element, transition_in, transition_out } from "svelte/internal";
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      attr(polygon, "points", polygon_points_value = "0 0 " +
      /*width*/
      ctx[0] + " 0 " +
      /*width*/
      ctx[0] + " " +
